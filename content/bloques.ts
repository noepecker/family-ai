...
export const bloques: Bloque[] = [
  ...
  },
  {
    ...
    long: "Actúa como X. Piensa paso a paso. Cuestiona la premisa. Autocorrígete. Da ejemplos. Back & forth. Cita fuentes. Varias IAs combinadas. Plantillas listas por nivel: de primera vez al ecosistema completo.",
  ...
  },
  {
    ...
    number: "11",
    title: "Deepfakes y la palabra clave",
    short: "Arup $25M, Biden robocall, cómo protegerse.",
    long: "Por qué preguntar a la IA si lo escribió ella no funciona. SynthID y C2PA Content Credentials. Casos reales: Arup $25M, robocall de Biden, Taylor Swift deepfakes, $4.900M en estafas a mayores. Las 6 reglas que SÍ funcionan en tu círculo cercano (palabra clave, búsqueda inversa, esperar 24h).",
